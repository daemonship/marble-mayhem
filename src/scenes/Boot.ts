...
export class Boot extends Phaser.Scene {
  ...
  create(): void {
    ...
    // Pre-generate all game textures here to avoid runtime GPU readbacks
    // that can cause WebGL performance warnings (GPU stall due to ReadPixels)
  ...
  private createGameTextures(): void {
    ...
    // and prevents runtime generateTexture calls during gameplay which can
    // trigger GPU readback warnings)
